...
void groupRMSNormV3(torch::TensorList const& inputs, torch::TensorList const& outputs, torch::TensorList const& weights,
    double eps, double weight_bias)
{
    ...
    tensorrt_llm::kernels::group_rms_norm::GroupRMSNormKernelV3Launcher<2>(params);
}
...
TORCH_LIBRARY_IMPL(trtllm, CUDA, m)
{
    ...
    m.impl("group_rms_norm_v3", &torch_ext::groupRMSNormV3);
