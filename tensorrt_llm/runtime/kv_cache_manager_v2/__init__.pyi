...
class KVCacheManager:
    ...
    # C++ backend only. Release invalidates metadata and must not raise or reenter KVCM.
    def set_gpu_eviction_callbacks(
        self,
        evict: Callable[[list[tuple[int, int]]], None] | None,
        release: Callable[[int, int], None] | None,
    ) -> None: ...
